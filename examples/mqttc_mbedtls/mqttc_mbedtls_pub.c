...
int main(int argc, const char *argv[]) 
{
    ...
    mqtterr = mqtt_init(&client, sockfd, sendbuf, sizeof(sendbuf), recvbuf, sizeof(recvbuf), NULL);
    if (mqtterr != MQTT_OK)
    {
    ...
    mqtterr = mqtt_connect(&client, "publishing_client", NULL, NULL, 0, NULL, NULL, 0, 400);
    if (mqtterr != MQTT_OK)
    {
